    ...
    if (mapp.length > 0) {
      for (var index = 0; index < mapp.length; index++) {
        var datatable = {
          ...
          qty: mapp[index].c9,
          uniT_PRICE: mapp[index].c10,
          amount: mapp[index].c11,
          batcH_LOT_NO: 1,
