    ...
    <form class="mt-8 space-y-6" onSubmit={handleSubmit}>
      ...
      <div class="rounded-md shadow-sm -space-y-px">
        <div>
          ...
          <input  onChange={handleChange} onBlur={handleBlur} value={values.L_Password} name="L_Password" type="password" autocomplete="current-password"  class="mt-3 appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Password" />
          <div className="h-4">
                      {errors.L_Password &&
                        touched.L_Password &&
                        <div className="input-feedback text-red-500 ml-5">
