...
function table() {
  ...
  const [searchtxtproductno, setsearchtxtproductno] = useState('');
  const [searchtxtinvoiceno, setsearchtxtinvoiceno] = useState('');
  ...
  const searchproducT_NO =()=>{

    if(searchtxtproductno!=''){
      setshowtable(datatable2.filter((x => x.producT_NO == searchtxtproductno)))
  ...
  const searchinvoicE_NO =()=>{

    if(searchtxtinvoiceno!=''){
      setshowtable(datatable2.filter((x => x.invoicE_NO == searchtxtinvoiceno)))
...
//console.log(searchtxt)
   ...
   Puschasing order list
          ...
          <div className="ml-5  mt-10   mr-5 ">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
  <div className="p-3 place-self-center" ><h2 className="text-xl blod"> รหัสผู้จำหน่าย	</h2></div>
  <div className="col-span-3 p-3">
  <div className="">
  <div className="bg-gray-100 flex items-center rounded-full shadow-xl">
    <input onChange={(e)=>setsearchtxtproductno(e.target.value)} className="bg-gray-100 rounded-l-full w-full py-4 px-6 text-gray-700 leading-tight focus:outline-none" id="search" type="text" placeholder="Search" />
    
    <div className="">
      <button  onClick={() => searchproducT_NO()} className="bg-blue-500 text-white rounded-full p-2 hover:bg-blue-400 focus:outline-none w-12 h-12 flex items-center justify-center">
  ...
  <div>
  <div className="p-3 place-self-center" ><h2 className="text-xl blod"> เลขที่ใบส่งของ</h2></div>
  <div className="col-span-3 p-3">
  <div className="">
  <div className="bg-gray-100 flex items-center rounded-full shadow-xl">
    <input onChange={(e)=>setsearchtxtinvoiceno(e.target.value)} className="bg-gray-100 rounded-l-full w-full py-4 px-6 text-gray-700 leading-tight focus:outline-none" id="search" type="text" placeholder="Search" />
    
    <div className="">
      <button  onClick={() => searchinvoicE_NO()} className="bg-blue-500 text-white rounded-full p-2 hover:bg-blue-400 focus:outline-none w-12 h-12 flex items-center justify-center">
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
      </button>
      </div>
  </div>
                    ...
                    <table className=" min-w-full divide-y divide-gray-200">
                      ...
                      <tbody className="bg-white ">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <button onClick={()=>handleedit(data.invoicE_NO,data.producT_NO) } className="rounded-full bg-pink-500 text-white h-9 w-9 flex-row items-center justify-center">
                            <svg 
